...
let x:string ="I like coding";
let y:string ="I like coding";
var result1= x==y;
console.log("Output of X==Y :" + result1);

//Tests for equality of strings
let x1:string="I like coding"
let y1:string="I don't like coding"
var result1= x1==y1;
console.log("Output of X==Y :" + result1);

//Test for lower case
let name1:string  = "hamza rehman"
let name_lower:string = name1.toLowerCase();
